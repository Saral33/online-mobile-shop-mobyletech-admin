      ...
      <Space direction="vertical">
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
          <Col md={8} sm={24} xs={24}>
            <Card style={{ textAlign: "center", backgroundColor: "#009432" }}>
              <Title level={1} style={{ color: "#fff" }}>
                {product || 0}
              </Title>
              <Text style={{ color: "#fff" }}>
                {" "}
                <LaptopOutlined /> Total Products
              </Text>
            </Card>
          </Col>
          <Col md={8} sm={24} xs={24}>
          ...
          <Col md={8} sm={24} xs={24}>
            <Card style={{ textAlign: "center", backgroundColor: "#B53471" }}>
              <Title level={1} style={{ color: "#fff" }}>
                {order || 0}
              </Title>
              <Text style={{ color: "#fff" }}>
                <ShoppingOutlined /> Total Orders
              </Text>
            </Card>
          </Col>
        </Row>
